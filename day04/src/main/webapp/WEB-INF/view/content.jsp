...
<body class="gray-bg">
        ...
        <div class="row">
			  <div class="">
				<div class="input-group">
			      ...
			      <input type="text" name="contentname" class="" id="txt_search_contentname" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>广告标题：</td>
								<td><input type="text" id=contentname name="contentname"
							...
							<tr>
							<td>日期：</td>
								<td><input type="date" id="creattime" name="creattime"
									class="form-control" aria-required="true" required/></td>
								<td>广告分类：</td>
								<td colspan="4">
	...
	function initEditUser(getSelection){
		...
		$('#contentname').val(getSelection.contentname);
		$('#contenturl').val(getSelection.contenturl);
		$('#price').val(getSelection.price);
		$('#creattime').val(new Date(getSelection.creattime).Format('yyyy-MM-dd'));
